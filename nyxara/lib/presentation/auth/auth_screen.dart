      ...
      child: Stack(
        children: [
          ...
          ...List.generate(6, (index) {
            return Positioned(
              top: 50.0 + (index * 120),
              left: (index % 2 == 0) ? -20 : MediaQuery.of(context).size.width - 60,
      ...
      children: [
        ...
        Container(
          decoration: BoxDecoration(
            ...
            border: Border.all(
              color: _isEmailValid ? AppColors.borderColor : AppColors.errorColor,
              width: 1,
            ),
          ),
          child: TextFormField(
            ...
            decoration: InputDecoration(
              ...
              prefixIcon: Icon(
                ...
                color: _isEmailValid ? AppColors.textSecondary : AppColors.errorColor,
      ...
      children: [
        ...
        Container(
          decoration: BoxDecoration(
            borderRadius: BorderRadius.circular(AppDimensions.buttonBorderRadius),
            border: Border.all(
              color: _isPasswordValid ? AppColors.borderColor : AppColors.errorColor,
              width: 1,
            ),
          ),
          child: TextFormField(
            ...
            decoration: InputDecoration(
              ...
              prefixIcon: Icon(
                Icons.lock_outline,
                color: _isPasswordValid ? AppColors.textSecondary : AppColors.errorColor,
                size: AppDimensions.iconM,
              ),
